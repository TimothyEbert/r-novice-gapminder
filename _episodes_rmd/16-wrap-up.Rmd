...
It helps to write structured programs: load data, declare constants and variables, declare functions, clean the data, code that uses data and functions to produce output, save the result. The structure for functions also follows this model. Modular and structured code is easier to follow and adapt.  
